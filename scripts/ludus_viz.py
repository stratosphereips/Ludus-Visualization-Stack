...
nohup python3 ludus_viz.py -bt TIME_IN_MINUTES
ctrl-z
jobs # note jobs id
disown -h %jobid
bg %jobid
...
if __name__ == "__main__":
    ...
    e_cmd = """curl -H 'Content-Type: application/json' -XPUT -u 'elastic:password' -p 'localhost:9200/_xpack/security/user/elastic/_password' -d '{{
"password" : "{}"
}}'""".format(decrypted[8])
